/*
        ...
        MoneyJavaGUI - Java Swing GUI Version
        ----------------------------------------
        This is the graphical version of the Money Java money manager.
        Features:
...
public class MoneyJavaGUI extends JFrame {
    ...
    public MoneyJavaGUI(User user) {
        this.user = user;
        setTitle("Money Java - Money Manager");
