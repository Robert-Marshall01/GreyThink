/**
 * Grey Capacitor - useAuth Hook
 *
 * Provides authentication state and actions for Capacitor components.
 ...
 * Uses MemoryTokenStorage by default (Capacitor-safe).
 *
...
export function useAuth(config?: AuthConfig): UseAuthReturn {
  ...
  useEffect(() => {
    ...
    // Use MemoryTokenStorage for Capacitor-safe token storage
